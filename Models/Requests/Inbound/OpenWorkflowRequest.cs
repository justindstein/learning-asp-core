        ...
        private string generateSuborderDescription(Suborder suborder)
        {
            ...
            if (!suborder.Decorations.IsNullOrEmpty())
            {
                ...
                foreach (Decoration decoration in suborder.Decorations)
                {
                    ...
                    ");
                    //decorationRows.AppendLine($@"<tr style='border:1px solid black'><td style='border:1px solid black'><a href='{decoration.LogoUrl}'><img src='{decoration.ImageUrl}' style='max-width:300px;max-height:600px'></a></td><td style='word-wrap:break-word;border:1px solid black'>{decoration.Notes}</td><td style='border:1px solid black'>{decoration.LogoType.GetDescription()}</td><td style='border:1px solid black'>{decoration.LogoPlacement.GetDescription()}</td></tr>");
                }
                ...
                ";
                //decorationTable = $@"<table style='width:100%;text-align:center;font-size:8pt;border:1px solid black;border-collapse:collapse'><caption><strong>Logos</strong></caption><tr style='border:1px solid black'><th style='width:20%;border:1px solid black'>Image</th><th style='width:30%;border:1px solid black'>Modification Notes</th><th style='width:20%;border:1px solid black'>Logo Type</th><th style='width:20%;border:1px solid black'>Logo Placement</th></tr>{decorationRows}</table>";
            }
            ...
            if (!suborder.OrderEntries.IsNullOrEmpty())
            {
                ...
                foreach (OrderEntry orderEntry in suborder.OrderEntries)
                {
                    ...
                    ");
                    //productRows.AppendLine($@"<tr style='border:1px solid black'><td style='border:1px solid black'><a href='{orderEntry.ProductUrl}'><img src='{orderEntry.ImageUrl}' style='max-width:300px;max-height:600px'></a></td><td style='word-wrap:break-word;border:1px solid black'>{orderEntry.ApprovalType.GetDescription()}</td><td style='border:1px solid black'>{orderEntry.Color}</td><td style='border:1px solid black'>{orderEntry.Quantity}</td></tr>");
                }
                ...
                ";
                //productTable = $@"<table style='width:100%;text-align:center;font-size:8pt;border:1px solid black;border-collapse:collapse'><caption><strong>Products</strong></caption><tr style='border:1px solid black'><th style='width:15%;border:1px solid black'>Image</th><th style='width:20%;border:1px solid black'>Approval</th><th style='width:15%;border:1px solid black'>Color</th><th style='width:10%;border:1px solid black'>Quantity</th></tr>{productRows}</table>";
            }
