namespace learning_asp_core.Models.Requests.Outbound
{
    ...
    public class CreateSuborderWorkItemRequest
    {
        ...
        public CreateSuborderWorkItemRequest(string customerName, int orderNumber, string parentRef)
        {
        ...
        public string toRequestBody()
        {
            return $@"
            [
                {{'op':'add','path':'/fields/System.Title','from':null,'value':'{_customerName} - {_orderNumber}'}},
